...
//  ###########################################################
var reverseArray = (arr: number[]): number[] => {
  let result: number[] = [];
...
//  ###########################################################
var countLetter = (word: string, letter: string): number => {
  let count: number = 0;
...
//  ###########################################################
var findDuplicates = (arr: number[]): number[] => {
...
var areAnagrams = (firstWord: string, secondWord: string): boolean => {
...
// ```
function longestIncreasingSubseq(arr: number[]): number {
  let maxLen = 0;
  let currentLen = 0;
